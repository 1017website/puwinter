...
<div class="page-header">
    <div>
        <h2>Paket Harga</h2>
        <p>Kelola paket langganan premium yang ditawarkan ke siswa.</p>
    </div>
</div>
...
<div style="display:grid; grid-template-columns:1fr 360px; gap:20px; align-items:flex-start;">
    ...
    <div style="display:flex; flex-direction:column; gap:14px;">
                ...
                <form method="POST" action="{{ route('admin.plans.update', $plan) }}">
                    ...
                    <div style="display:grid; grid-template-columns:1fr 1fr; gap:12px; margin-bottom:12px;">
                        <div class="form-group" style="margin-bottom:0; grid-column:span 2;">
                            <label style="font-size:11px; font-weight:700; color:var(--muted);">Nama Paket</label>
        ...
        <div class="card" style="text-align:center; padding:60px; color:var(--muted);">
            ...
            <p style="font-size:14px; font-weight:600;">Belum ada paket harga.</p>
        </div>
        @endforelse
    </div>
        ...
        <div class="card">
            ...
            <form method="POST" action="{{ route('admin.plans.store') }}">
                ...
                <div class="form-group">
                    <label>Nama Paket <span style="color:var(--danger);">*</span></label>
                    <input type="text" name="name" class="form-control" placeholder="Paket 1 Bulan" required value="{{ old('name') }}">
                ...
                <div style="display:grid; grid-template-columns:1fr 1fr; gap:10px;">
                    <div class="form-group">
                        ...
                        <input type="number" name="price" class="form-control" placeholder="89000" required value="{{ old('price') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="original_price" class="form-control" placeholder="129000" required value="{{ old('original_price') }}">
                    </div>
                </div>
                <div class="form-group">
                    <label>Durasi (bulan) <span style="color:var(--danger);">*</span></label>
                    <input type="number" name="duration_months" class="form-control" placeholder="1" min="1" required value="{{ old('duration_months', 1) }}">
                </div>
                <div class="form-group">
                    <label>Fitur <span style="font-size:11px; color:var(--muted); font-weight:400;">(1 baris = 1 fitur)</span></label>
                    <textarea name="features" class="form-control" rows="5" style="resize:vertical;" placeholder="Akses semua kelas&#10;Live class eksklusif&#10;Tryout tanpa batas">{{ old('features') }}</textarea>
                </div>
                <div class="form-group">
