...
<div style="max-width:680px;">
    ...
    <div class="card">
        <form method="POST" action="{{ route('admin.courses.update', $course) }}" enctype="multipart/form-data" x-data="{ ctype: '{{ old('course_type', $course->course_type) }}', get typeHint(){ return this.ctype==='extra' ? 'Bebas diakses semua siswa tanpa langganan premium.' : (this.ctype==='private' ? 'Hanya untuk member premium.' : 'Mengikuti kelas siswa dan flag premium di bawah.'); } }">
            @csrf @method('PUT')
            ...
            <div style="display:grid; grid-template-columns:1fr 1fr; gap:14px;">
                ...
                <div class="form-group">
                    ...
                    <select name="course_type" class="form-control" x-model="ctype">
                        ...
                        <option value="private" {{ old('course_type', $course->course_type) == 'private' ? 'selected' : '' }}>Private / Eksklusif — wajib premium</option>
                    </select>
