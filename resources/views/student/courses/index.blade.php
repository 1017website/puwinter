...
{{-- Filter tabs --}}
<div class="student-filter-scroll" style="display:flex; gap:4px; background:#fff; border:1px solid var(--border); border-radius:10px; padding:4px; width:fit-content; margin-bottom:24px;">
...
@else
    <div class="student-card-grid student-grid-4" style="display:grid; grid-template-columns:repeat(4, 1fr); gap:16px;">
