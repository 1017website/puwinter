...
@php $subtitle = 'Kelola kelas dan kelas online kamu.'; @endphp
...
<div style="background:linear-gradient(135deg,#1E293B,#7C3AED); border-radius:16px; padding:28px 32px; margin-bottom:24px; position:relative; overflow:hidden;">
    ...
    <div style="position:relative; z-index:1;">
        ...
        <p style="font-size:13px; color:rgba(255,255,255,0.7);">Kelola kelas dan kelas online kamu dari sini.</p>
    </div>
</div>
